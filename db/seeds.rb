...
Event.create!(user_id: 1, habit_id: 1, title: "Early bird gets the worm", start: "2022-07-22", end: "2022-10-21", color: "aa")
Event.create!(user_id: 1, goal_id: 1, title: "Wake up at 8:00am", start: "2022-07-22", end: "2022-07-28", color: "ab")
Event.create!(user_id: 1, goal_id: 2, title: "Wake up at 7:45am", start: "2022-07-29", end: "2022-08-04", color: "ab")
Event.create!(user_id: 1, goal_id: 3, title: "Wake up at 7:30am", start: "2022-08-05", end: "2022-08-11", color: "ab")
Event.create!(user_id: 1, goal_id: 4, title: "Wake up at 7:15am", start: "2022-08-12", end: "2022-08-18", color: "ab")
Event.create!(user_id: 1, goal_id: 5, title: "Wake up at 7:00am", start: "2022-08-19", end: "2022-08-25", color: "ab")
Event.create!(user_id: 1, habit_id: 1, title: "#gains", start: "2022-08-19", end: "2022-11-18", color: "ba")
Event.create!(user_id: 1, goal_id: 6, title: "Morning weightlifting!", start: "2022-08-19", end: "2022-08-25", color: "bb")
Event.create!(user_id: 1, goal_id: 7, title: "Wake up at 6:45am", start: "2022-08-26", end: "2022-09-02", color: "ab")
Event.create!(user_id: 1, goal_id: 8, title: "Morning weightlifting!", start: "2022-08-26", end: "2022-09-02", color: "bb")
Event.create!(user_id: 1, habit_id: 3, title: "Bookworm", start: "2022-09-02", end: "2022-12-01", color: "ca")
Event.create!(user_id: 1, goal_id: 9, title: "Read at least 1 chapter", start: "2022-09-02", end: "2022-09-08", color: "cb")
Event.create!(user_id: 1, goal_id: 10, title: "Wake up at 6:30am", start: "2022-09-03", end: "2022-09-09", color: "ab")
Event.create!(user_id: 1, goal_id: 11, title: "Morning weightlifting!", start: "2022-09-03", end: "2022-09-09", color: "bb")
Event.create!(user_id: 1, goal_id: 9, title: "Read at least 1 chapter", start: "2022-09-09", end: "2022-09-16", color: "cb")
Event.create!(user_id: 1, goal_id: 10, title: "Wake up at 6:15am", start: "2022-09-10", end: "2022-09-17", color: "ab")
Event.create!(user_id: 1, goal_id: 11, title: "Morning weightlifting!", start: "2022-09-10", end: "2022-09-17", color: "bb")
